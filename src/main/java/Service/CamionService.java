...
public class CamionService {
    ...
    public List<Camion> buscarCamion(Camion dtocamion) throws ElementoNoEncontradoException {
        try {
    ...
    public void modificarCamion(Camion camion) throws ElementoNoEncontradoException {
